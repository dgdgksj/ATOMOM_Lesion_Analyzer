from segmentation.mrcnn.config import Config as Mask_RCNN_Config
...
class Cfg_1st_EffB7_Su_Cls_5(Config_eff):
	...
	verbose = False
	topk = 5
	model_path = repo_path("classification", "efficientnet_models", "first_learning_result_efficientNet_b7_su_class_5.pt")
...
class Cfg_2nd_EffB0_Su_Cls_41(Config_eff):
	...
	verbose = False
	topk = 5
	model_path = repo_path("classification", "efficientnet_models", "second_learning_result_efficientNet_b0_su_class_41.pt")
...
class Cfg_2nd_EffB0_Ming_Cls_41(Config_eff):
	...
	verbose = False
	topk = 5
	model_path = repo_path("classification", "efficientnet_models", "second_learning_result_efficientNet_b0_mingeon_class_41.pt")
	model_name = 'efficientnet-b0'
	class_names = {
		"000": "normal_skin",
		"001": "atopy",
...
class Cfg_2nd_EffB0_Ming_Cls_6(Config_eff):
	...
	verbose = False
	topk = 5
	model_path = repo_path("classification", "efficientnet_models", "second_learning_result_efficientNet_b0_mingeon_class_6.pt")
	model_name = 'efficientnet-b0'
	class_names = {
		"000": "normal_skin",
		"001": "atopy",
...
class Cfg_2nd_EffB7_Ming_Cls_6(Config_eff):
	...
	verbose = False
	topk = 5
	model_path = repo_path("classification", "efficientnet_models", "second_learning_result_efficientNet_b7_mingeon_class_6.pt")
	model_name = 'efficientnet-b7'
	class_names = {
		"000": "normal_skin",
		"001": "atopy",
...
class Cfg_3rd_EffB0_Ming1_Cls_4(Config_eff):
	...
	verbose = False
	topk = 5
	model_path = repo_path("classification", "efficientnet_models", "third_learning_result_efficientNet_b0_mingeon_1_class_4.pt")
	model_name = 'efficientnet-b0'
	class_names = {
		"000": "normal_skin",
		"001": "atopy",
...
class Cfg_3rd_EffB0_Ming2_Cls_4(Config_eff):
	...
	verbose = False
	topk = 5
	model_path = repo_path("classification", "efficientnet_models", "third_learning_result_efficientNet_b0_mingeon_2_class_4.pt")
	model_name = 'efficientnet-b0'
	class_names = {
		"000": "normal_skin",
		"001": "atopy",
...
class Cfg_3rd_EffB0_Ming3_Cls_4(Config_eff):
	...
	verbose = False
	topk = 5
	model_path = repo_path("classification", "efficientnet_models", "third_learning_result_efficientNet_b0_mingeon_3_class_4.pt")
	model_name = 'efficientnet-b0'
	class_names = {
		"000": "normal_skin",
		"001": "atopy",
...
class Cfg_3rd_EffB0_Ming4_Cls_4(Config_eff):
	...
	verbose = False
	topk = 5
	model_path = repo_path("classification", "efficientnet_models", "third_learning_result_efficientNet_b0_mingeon_4_class_4.pt")
	model_name = 'efficientnet-b0'
	class_names = {
		"000": "normal_skin",
		"001": "atopy",
...
class Config_yolo():
	model_path = repo_path("segmentation", "yolo_models", "best_n.pt")
	model_names = None
	display = False
	save_path = None
	verbose = False
...
class Config_mrcnn(Mask_RCNN_Config):
	...
	weights = repo_path("segmentation", "mrcnn_models", "mask_rcnn_atopy_0035.h5")
	NAME = "atopy"
