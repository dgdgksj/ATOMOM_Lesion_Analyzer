...
def get_product(lis,cur,score):
    ...
    if (curResult == False):
        ...
        #           check[0][1][0]['products']['mainProduct']['productName'],curScore)
        #     best, bestScore = check
...
#         print("'media' in request.FILES",'media' in request.FILES)
#         print("'pos' not in request.FILES",'pos' not in request.FILES)
#         print("'media' in request.FILES and 'pos' not in request.FILES",'media' in request.FILES and 'pos' not in request.FILES)
#         uploadfile = request.FILES.get('media', '')
#         if uploadfile != '':
#             print("여기 들어2옴 ")
#             # rows = int(request.COOKIES.get('rows', ''))
...
#                 #
#                 # data=json.dumps(data, ensure_ascii=False, indent="\t", cls=NpEncoder)
#                 # print(data)
#                 return JsonResponse(data)
#
